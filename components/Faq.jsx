...
const Faq = () => {
  ...
  return (
    ...
    <section>
      <div class="container mx-auto flex px-5 py-32 lg:flex-row flex-col ">
        <div class="lg:flex-grow md:w-1/2 flex flex-col md:items-start  mb-16 md:mb-0 ">
          <div className="mb-4 ">
          ...
          <p class="lg:w-2/3 leading-relaxed text-xl text-gray-500">
            Check out our most commonly asked questions below to find the
            information you need.
          </p>
        </div>

        <div class="lg:flex-grow lg:w-1/2 flex flex-col md:items-start  mb-16 md:mb-0 ">
