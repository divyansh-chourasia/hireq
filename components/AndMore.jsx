    ...
    <section className="bg-[#07061B] text-[#757576]">
      <div className="container px-5 py-20 mx-auto ">
        <div className="  w-full py-8">
          ...
          <h1 className="title-font md:text-6xl text-3xl mb-6 font-medium text-[#FDF2EC]">
        ...
        <div className="flex flex-wrap -m-4 ">
          <div className="xl:w-1/3 md:w-1/2 p-6  ">
            <div className="  bg-[#212121] px-8 py-12 rounded-3xl text-center ">
              <div className="p-4 mb-4 inline-flex text-3xl items-center justify-center rounded-3xl  bg-[#8247FF] text-white ">
                <AiFillMobile />
              </div>
          ...
          <div className="xl:w-1/3 md:w-1/2 p-6  ">
            <div className="  bg-[#212121] px-8 py-12 rounded-3xl text-center  h-full">
              <div className="p-4 mb-4 inline-flex text-3xl items-center justify-center rounded-3xl  bg-[#8247FF] text-white ">
                <HiFire />
              </div>
