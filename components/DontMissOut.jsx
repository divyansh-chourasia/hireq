...
const DontMissOut = () => {
  return (
    <section className="bg-gradient-to-b from-[#fff] via-transparent to-[rgb(253,242,236)]">
      <div className="container mx-auto flex justify-center px-5 py-24 md:flex-row flex-col items-center border rounded-3xl bg-white">
        <div className="lg:max-w-lg lg:w-full md:w-1/2 ">
          ...
          <p className="mb-8 leading-relaxed text-xl text-[#767675]">
            Join our community of ambitious <br /> individuals and organizations
            eager <br />
            to make a difference.
          </p>
          <button className="inline-flex text-white bg-[#8247FF]  border-0 py-4 px-10 font-semibold focus:outline-none rounded-2xl text-lg">
            Try out now
          </button>
        </div>
